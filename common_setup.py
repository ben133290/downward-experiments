...
BENCHMARKS = list(set(['muddy-children', 'muddy-child', 'blocker', 'pathways', 'psr-middle', 'sum', 'word-rooms', 'collab-and-comm', 'psr-large', 'miconic-fulladl', 'telegraphs', 'social-planning', 'acc-cc2', 'ged1-ds2nd', 'ged1-ds1', 'assembly', 'miconic-axioms', 'explode',]))
