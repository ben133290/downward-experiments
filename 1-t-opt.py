...
exp.add_absolute_report_step(attributes=["error", "translator_exit_code", "translator_task_size", "memory", "cost", "planner_memory", "expansions_until_last_jump", "generated", "planner_time", "coverage", "task_size", "translator_axioms", "translator_derived_variables", "variables"])
